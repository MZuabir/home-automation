...
import 'package:home_automation/app/ML/Recognition.dart';
import 'package:home_automation/app/ML/Recognizer.dart';
import 'package:image_picker/image_picker.dart';
import 'package:image/image.dart' as img;

class EnrollFaceScreen extends StatefulWidget {
  const EnrollFaceScreen({Key? key}) : super(key: key);

  @override
  State<EnrollFaceScreen> createState() => _HomePageState();
}

class _HomePageState extends State<EnrollFaceScreen> {
